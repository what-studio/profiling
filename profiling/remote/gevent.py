...
class GeventProfilingServer(StreamServer, BaseProfilingServer):
    ...
    def __init__(self, listener, profiler=None, interval=INTERVAL, log=LOG,
                 pickle_protocol=PICKLE_PROTOCOL, **server_kwargs):
        StreamServer.__init__(self, listener, **server_kwargs)
        BaseProfilingServer.__init__(
            self, profiler, interval, log, pickle_protocol)
